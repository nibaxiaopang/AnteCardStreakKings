...
#import "AnteCardWbViJBri.h"

@implementation AnteCardWbViJBri {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    AnteCardWbViewJBriBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [AnteCardWbViewJBriBase enableLogging]; }

+ (instancetype)bridForWebView:(WKWebView*)webView {
    AnteCardWbViJBri* bridge = [[self alloc] init];
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[AnteCardWbViewJBriBase alloc] init];
    _base.delegate = self;
}
